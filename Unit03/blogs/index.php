...
// Câu lệnh truy vấn
$query_two_posts = "SELECT p.*, c.title as 'category' FROM posts 
p LEFT JOIN categories c ON p.category_id = c.id WHERE p.status= 1 ORDER BY
...
//Lấy một bài viết
$query_post_col_12 = "SELECT * FROM posts ORDER BY created_at desc limit 6,7";

// Thuc thi cau lenh
$result_col_12 = $conn->query($query_post_col_12 );

// Tao 1 mang de chua du lieu
$post_col_12 = array();

while($row = $result_col_12->fetch_assoc()){
	$post_col_12[] = $row;
}
//End lấy một bài viết
				...
				<div class="row">	
					...
					<div class="col-md-6">
						<div class="post post-thumb">
							<a class="post-img" href="blog-post.php?id=<?=$post['id']?>"><img src="<?= $post['thumbnail'] ?>" alt="" width="300px" height="600px"></a>
							<div class="post-body">
								<div class="post-meta">
