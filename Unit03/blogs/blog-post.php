...
//End load category
$id = $_GET['id'];
$query = "SELECT p.*,c.title AS 'cate', a.name FROM posts p LEFT JOIN categories c ON p.category_id = c.id 
LEFT JOIN authors a ON p.author_id = a.id WHERE p.id=".$id;

$result_post = $conn->query($query);
$post = $result_post->fetch_assoc();

//Most read
$query_most_read = "SELECT * FROM posts p WHERE p.category_id= ".$id." ORDER BY p.created_at desc limit 3";
$result_most_read = $conn->query($query_most_read);
$most_read_3= $result_most_read->fetch_assoc();
$most_read_arr = array();
				...
				<div class="row">
					...
					<div class="col-md-4">
						...
						<div class="aside-widget">
							...
							<?php foreach($most_read_arr as $post) {
							?>
